...
const Index4FeaturesTextBlockTwo = () => {
    return (
        <section className="feature-text-block-two feature-shape-bg">
                    ...
                    <div className="col-xxl-5 col-lg-6 col-md-10 wow fadeInRight">
                        <div className="block-text">
                            ...
                            <p className="big-text">
                                ...
                                competitive pricing and customersupport. It’s
                                throughly refresing to get such a personal
                                touch.
                            </p>
                            <ul className="mt-50 chech-list">
                                <li>
                                    <i className="fal fa-check" /> Refresing to
                                ...
                                <li>
                                    <i className="fal fa-check" /> Velit esse
...
export default Index4FeaturesTextBlockTwo;
